...
{
    [SerializeField] private float _movSpeed = 3.5f, _rotSpeed=10.0f;
    private Rigidbody _rb;
    [SerializeField] private Vector3 _dir = new Vector3(0.0f, 0.0f, 0.0f);
    [SerializeField] private Vector3 _viewPlayer;
